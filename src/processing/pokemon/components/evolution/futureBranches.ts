...
import {
  ...
  FutureEvolutionBranch,
  Pokemon,
  PokemonEvolution,
} from "@outcome/pokemon";
      ...
      .map(
        (futurePokemon) =>
          ({
            ...
            costToEvolve: this.GetEvolutionCost(
              TemplateIdToId(futurePokemon),
              rawPokemon
            ),
