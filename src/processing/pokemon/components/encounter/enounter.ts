  ...
  Process(pokemon: Pokemon, rawPokemon: ItemTemplate): Pokemon {
    pokemon.encounter = {
      ...
      maxPokemonActionFrequency:
        rawPokemon.pokemon.encounter.maxPokemonActionFrequencyS,
      minPokemonActionFrequency:
        rawPokemon.pokemon.encounter.minPokemonActionFrequencyS,
      movementType: rawPokemon.pokemon.encounter.movementType
        ? Util.SnakeCase2Identifyable(rawPokemon.pokemon.encounter.movementType)
        : null,
    };
